...
import { homeRoutes, _1337xRoutes, nyaaRoutes, ytsRoutes, healthRoutes } from './routes';
...
app.listen(port, () => {
  ...
  if (cacheService.isAvailable()) {
    ...
    console.log('Redis caching disabled - provide UPSTASH_REDIS_REST_URL and UPSTASH_REDIS_REST_TOKEN to enable');
  }
});