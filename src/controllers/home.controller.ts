 ...
 */
export const getHome = createDocumentationHandler('../docs/home.md', 'Torrent API Documentation');
...
export const clearCache = async (req: Request, res: Response) => {
  ...
  try {
    ...
    res.status(500).json({ error: `Failed to clear cache: ${(err as Error).message}` });
  }
};